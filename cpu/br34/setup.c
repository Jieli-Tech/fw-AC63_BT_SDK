...
void setup_arch()
{
    ...
    /* extern void  set_fix_noise_dly_time(u8 dly); */
    /* set_fix_noise_dly_time(8); //这个可以修改开dac的延时,单位10ms,用来解决某些芯片开dac出现的杂声，若不想延时，传0即可 */
    ...
    clk_voltage_init(CLOCK_MODE_USR, SYSVDD_VOL_SEL_126V);
