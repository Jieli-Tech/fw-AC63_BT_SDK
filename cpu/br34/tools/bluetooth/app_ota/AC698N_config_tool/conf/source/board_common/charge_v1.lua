...
local CHARGE_FULL_VOL = cfg:enumMap("充电满电压选择(3.962V ~ 4.611V):",
	{
		[0] = "3.962V", 
		[1] = "4.002V", 
		[2] = "4.044V",
...
local CHARGE_FULL_VOL_OUPUT_TABLE = {
    [0] = "CHARGE_FULL_V_3962",
    [1] = "CHARGE_FULL_V_4002",
    [2] = "CHARGE_FULL_V_4044",
    [3] = "CHARGE_FULL_V_4086",
    [4] = "CHARGE_FULL_V_4130",
    [5] = "CHARGE_FULL_V_4175",
    [6] = "CHARGE_FULL_V_4222",
    [7] = "CHARGE_FULL_V_4270",
    [8] = "CHARGE_FULL_V_4308",
    [9] = "CHARGE_FULL_V_4349",
    [10] = "CHARGE_FULL_V_4391",
    [11] = "CHARGE_FULL_V_4434",
    [12] = "CHARGE_FULL_V_4472",
    [13] = "CHARGE_FULL_V_4517",
    [14] = "CHARGE_FULL_V_4564",
    [15] = "CHARGE_FULL_V_4611",
}
...
--[[=============================== 配置子项1-3: full_v ================================--]]
local full_v = cfg:enum("充电满电压", CHARGE_FULL_VOL, 6)
full_v:setOSize(1)
full_v:setTextOut(
	function (ty) 
		if (ty == 3) then
