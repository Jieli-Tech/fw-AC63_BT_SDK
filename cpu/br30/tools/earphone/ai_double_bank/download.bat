...
..\..\isd_download.exe isd_config.ini -tonorflash -dev br30 -boot 0x2000 -div8 -wait 300 -uboot ..\..\uboot.boot -app app.bin cfg_tool.bin  -res tone.cfg config.dat ..\..\p11_code.bin md5.bin -uboot_compress
