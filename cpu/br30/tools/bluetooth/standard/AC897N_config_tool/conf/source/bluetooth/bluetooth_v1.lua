...
dms_agc.dms_ndt_max_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(dms_agc.dms_ndt_max_gain.cfg, 0.0, 24.0, 0.1, 1),
    cfg:stLabel("(单端讲话放大上限， 设置范围: 0 ~ 24 dB，默认值：12.0 dB)"),
    cfg:stSpacer(),
};
...
dms_agc.dms_ndt_min_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(dms_agc.dms_ndt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
    cfg:stLabel("(单端讲话放大下限， 设置范围: -20.0 ~ 24.0 dB，默认值：0 dB)"),
    cfg:stSpacer(),
};
...
dms_agc.dms_dt_max_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(dms_agc.dms_dt_max_gain.cfg, 0.0, 24.0, 0.1, 1),
...
dms_agc.dms_dt_min_gain.hbox_view = cfg:hBox {
    ...
    cfg:dspinView(dms_agc.dms_dt_min_gain.cfg, -20.0, 24.0, 0.1, 1),
    cfg:stLabel("(双端讲话放大下限， 设置范围: -20.0 ~ 24.0 dB，默认值：0 dB)"),
    cfg:stSpacer(),
};
