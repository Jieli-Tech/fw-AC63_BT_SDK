#ifndef CONFIG_BOARD_AC6321A_STAND_KEYBOARD_POST_BUILD_CFG_H
#define CONFIG_BOARD_AC6321A_STAND_KEYBOARD_POST_BUILD_CFG_H
...
#if CONFIG_LP_TOUCH_KEY_EN || TCFG_MATRIX_KEY_ENABLE
