#ifndef CONFIG_BOARD_AC6379B_MOUSE_CFG_H
#define CONFIG_BOARD_AC6379B_MOUSE_CFG_H

#ifdef CONFIG_BOARD_AC6379B_MOUSE

#include "board_ac6379b_mouse_global_build_cfg.h"
...
#define TCFG_IOKEY_MOUSE_LK_PORT		            IO_PORTA_05
#define TCFG_IOKEY_MOUSE_RK_PORT		            IO_PORTA_06
#define TCFG_IOKEY_MOUSE_HK_PORT		            IO_PORT_DP
...
#define TCFG_ADKEY_PORT                     IO_PORTB_06//IO_PORT_DM         //AD按键端口(需要注意选择的IO口是否支持AD功能)
/*AD通道选择，需要和AD按键的端口相对应:
  ...
  AD_CH_PB2
 */
#define TCFG_ADKEY_AD_CHANNEL               AD_CH_PB6//AD_CH_DM
...
#define TCFG_OPTICAL_SENSOR_SCLK_PORT             IO_PORTC_04
#define TCFG_OPTICAL_SENSOR_DATA_PORT             IO_PORTC_05
...
#define TCFG_CODE_SWITCH_A_PHASE_PORT             IO_PORTB_07
#define TCFG_CODE_SWITCH_B_PHASE_PORT             IO_PORTB_06
