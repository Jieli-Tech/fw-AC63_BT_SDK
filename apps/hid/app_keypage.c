...
#define  REPROT_INFO_LEN    7

static const u8 key_pp_press_table[][REPROT_INFO_LEN] = {
    {0x07, 0x07, 0x70, 0x07, 0x70, 0x07, 0x01},
    {0x00, 0x07, 0x70, 0x07, 0x70, 0x07, 0x00},
};

static const u8 key_one_press_table[][REPROT_INFO_LEN] = {
    {0x07, 0x08, 0x00, 0x08, 0x60, 0x0d, 0x01},
    {0x00, 0x08, 0x00, 0x08, 0x60, 0x0d, 0x00},
};


static const u8 key_left_table[][REPROT_INFO_LEN] = {
    {0x07, 0x05, 0xa0, 0x0f, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0xa0, 0x0e, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0x48, 0x0d, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0x1c, 0x0c, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0x1c, 0x0b, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0xf0, 0x0a, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0xc4, 0x09, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0x98, 0x08, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0x6c, 0x07, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0x40, 0x06, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0x14, 0x05, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0x14, 0x04, 0x70, 0x03, 0x01},
    {0x07, 0x05, 0xe8, 0x03, 0x70, 0x03, 0x01},
    {0x00, 0x05, 0xbc, 0x02, 0x70, 0x03, 0x00},
};

static const u8 key_right_table[][REPROT_INFO_LEN] = {
    {0x07, 0x04, 0x32, 0x00, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0x32, 0x01, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0x8a, 0x02, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0xb6, 0x03, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0xe2, 0x04, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0xe2, 0x05, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0x0e, 0x06, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0x3a, 0x07, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0x66, 0x08, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0x92, 0x09, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0xbe, 0x0a, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0xea, 0x0b, 0x70, 0x03, 0x01},
    {0x07, 0x04, 0xea, 0x0c, 0x70, 0x03, 0x01},
    {0x00, 0x04, 0x16, 0x0d, 0x70, 0x03, 0x00},
};

static const u8 key_up_table[][REPROT_INFO_LEN] = {
    {0x07, 0x06, 0x70, 0x07, 0x88, 0x0d, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x80, 0x0c, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x80, 0x0b, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x28, 0x0a, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x28, 0x09, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0xfc, 0x08, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0xd0, 0x07, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0xa4, 0x06, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x78, 0x05, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x4c, 0x04, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x20, 0x03, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x4c, 0x02, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0xf4, 0x01, 0x01},
    {0x00, 0x06, 0x70, 0x07, 0xc8, 0x00, 0x00},
};


static const u8 key_down_table[][REPROT_INFO_LEN] = {
    {0x07, 0x06, 0x70, 0x07, 0xf4, 0x01, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0xf4, 0x02, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0xf4, 0x03, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x4c, 0x04, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x78, 0x05, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0xa4, 0x06, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0xd0, 0x07, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0xfc, 0x08, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0xfc, 0x09, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x28, 0x0a, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x54, 0x0b, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x78, 0x0c, 0x01},
    {0x07, 0x06, 0x70, 0x07, 0x78, 0x0d, 0x01},
    {0x00, 0x06, 0x70, 0x07, 0xac, 0x0d, 0x00},
};

static const u8 key_volume_increase[3] =  {0x02, 0x00, 0x00};
static const u8 key_volume_dec[3]      =  {0x01, 0x00, 0x00};
static const u8 key_volume_null[3]     =  {0x00, 0x00, 0x00};

#define KEY_DELAY_TIME()  os_time_dly(2)
...
static void app_key_deal_test(u8 key_type, u8 key_value)
{
    ...
    if (key_type == KEY_EVENT_HOLD) {
        ...
        case 1:
            hid_data_send_pt(3, key_volume_increase, 3);
            KEY_DELAY_TIME();
            hid_data_send_pt(3, key_volume_null, 3);
            break;

        case 2:
            hid_data_send_pt(3, key_volume_dec, 3);
            KEY_DELAY_TIME();
            hid_data_send_pt(3, key_volume_null, 3);
            break;
