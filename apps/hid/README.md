 ...
 * 以鼠标 APP_MOUSE 为例子，SDK 的目录结构如图 1.1 所示。
 ![enter image description here](/api/file/getImage?fileId=5efb2c4b783a4c2b3a00007d)
...
![enter image description here](/api/file/getImage?fileId=5efb2a08783a4c2b3a00007c)
...
### 4.1 APP 总体框架
 ...
 ![enter image description here](/api/file/getImage?fileId=5efb2ccf783a4c2b3a00007e)
...
![enter image description here](/api/file/getImage?fileId=5efb2dff783a4c2b3a000080)
...
![enter image description here](/api/file/getImage?fileId=5efc413d783a4c2b3a000085)

 * 配置示例
IOKEY 参数在板级配置文件中（c 文件和 h 文件）进行配置，配置示例如表 2-2 所示。
![enter image description here](/api/file/getImage?fileId=5efc41e4783a4c2b3a000086)
...
![enter image description here](/api/file/getImage?fileId=5efc4559783a4c2b3a000087)

 * 配置示例
 ADKEY参数在板级配置文件中（c文件和h文件）进行配置，配置示例如表2-4所示。
![enter image description here](/api/file/getImage?fileId=5efc4559783a4c2b3a00008a)
 
### 5.3 按键扫描参数配置
在IOKEY或者ADKEY使能后，按键扫描代码就会注册定时器定时扫描按键是否被按下，按键扫描参数可以在文件apps/common/key/iokey.c或adkey.c中配置，可供配置的参数表2-5所示。
![enter image description here](/api/file/getImage?fileId=5efc455a783a4c2b3a00008b)

### 5.4 按键事件处理
目前在HID_SDK中实现了的一些按键通用事件如表2-6所示。
![enter image description here](/api/file/getImage?fileId=5efc4559783a4c2b3a000088)
 ...
 * 组合键功能
 ...
 配置示例如表2-8所示。
![enter image description here](/api/file/getImage?fileId=5efc455a783a4c2b3a00008c)
...
![enter image description here](/api/file/getImage?fileId=5efc46cd783a4c2b3a00008d)
...
![enter image description here](/api/file/getImage?fileId=5efc48ed783a4c2b3a00008f)
 ...
 * 芯片功耗
![enter image description here](/api/file/getImage?fileId=5efc4aab783a4c2b3a000092)
