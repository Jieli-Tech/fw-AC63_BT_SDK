#ifndef CONFIG_BOARD_AC635N_FMY_CFG_H
#define CONFIG_BOARD_AC635N_FMY_CFG_H

#include "board_ac635n_fmy_global_build_cfg.h"
...
//                                 fmy                                        //
//*********************************************************************************//
#define  SOUND_GPIO_PORT                IO_PORTC_05
#define  SOUND_PASSIVE_BUZZER           DISABLE_THIS_MOUDLE                          // 是否采用无源蜂鸣器-PWM推声

#if SOUND_PASSIVE_BUZZER
#define DEV_SOUND_PWM_CH                 pwm_ch5                                    // 注意根据IO选择对应的CH并注意高低引脚
// ac635的mcpwm硬件引脚，上下为一对：---CH0---     ---CH1---    ---CH2---    ---CH3---    ---CH4---    ---CH5---
...
//#define  LED_KEY_GAPIO_PORT             IO_PORTC_02
#define  LED_PAIR_GAPIO_POR             IO_PORTC_01

//*********************************************************************************//
//                                 IIC配置                                        //
//*********************************************************************************//
/*软件IIC设置*/
#define TCFG_SW_I2C0_CLK_PORT               IO_PORTB_09                             //软件IIC  CLK脚选择
#define TCFG_SW_I2C0_DAT_PORT               IO_PORTB_10                             //软件IIC  DAT脚选择
...
#define TCFG_LOWPOWER_LOWPOWER_SEL			1                            //SNIFF状态下芯片是否进入powerdown
/*强VDDIO等级配置,可选：
