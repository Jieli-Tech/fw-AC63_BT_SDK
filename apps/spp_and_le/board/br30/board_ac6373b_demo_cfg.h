#ifndef CONFIG_BOARD_AC6373B_DEMO_CFG_H
#define CONFIG_BOARD_AC6373B_DEMO_CFG_H

#include "board_ac6373b_demo_global_build_cfg.h"

#ifdef CONFIG_BOARD_AC6373B_DEMO
