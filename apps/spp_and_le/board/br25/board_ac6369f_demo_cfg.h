#ifndef CONFIG_BOARD_AC6369F_DEMO_CFG_H
#define CONFIG_BOARD_AC6369F_DEMO_CFG_H

#include "board_ac6369f_demo_global_build_cfg.h"

#ifdef CONFIG_BOARD_AC6369F_DEMO
