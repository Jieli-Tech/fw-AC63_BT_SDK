#ifndef CONFIG_BOARD_AC6363F_DEMO_CFG_H
#define CONFIG_BOARD_AC6363F_DEMO_CFG_H

#include "board_ac6363f_demo_global_build_cfg.h"

#ifdef CONFIG_BOARD_AC6363F_DEMO
