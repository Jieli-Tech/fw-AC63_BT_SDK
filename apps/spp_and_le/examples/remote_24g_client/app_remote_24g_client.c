...
#define LOG_TAG_CONST       REMOTE_C
#define LOG_TAG             "[REMOTE_C]"  //暂时不修改
...
//---------------------------------------------------------------------
void remote_24g_set_soft_poweroff(void)
{
    log_info("set_soft_poweroff\n");
    is_app_remote_24g_active = 1;
...
//ble 接收设备数据
void remote_24g_ble_hid_input_handler(u8 *packet, u16 size)
{
...
void remote_24g_hid_output_handler(u8 report_type, u8 report_id, u8 *packet, u16 size)
{
...
static u8 remote_24g_state_idle_query(void)
{
    return !is_app_remote_24g_active;
}

REGISTER_LP_TARGET(remote_state_lp_target) = {
    .name = "remote_24g_state_deal",
    .is_idle = remote_24g_state_idle_query,
};
