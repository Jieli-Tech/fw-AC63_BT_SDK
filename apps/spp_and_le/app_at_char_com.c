...
static void app_start()
{
...
#if TCFG_USER_EDR_ENABLE && CONFIG_APP_AT_CHAR_COM
    ...
    sys_timer_add(NULL, app_timer_handler, 1000);
#endif
}
...
void bt_wait_phone_connect_control_ext(u8 inquiry_en, u8 page_scan_en)
{
#if(TCFG_USER_EDR_ENABLE && CONFIG_APP_AT_CHAR_COM && TEST_AUTO_BT_OPEN)
...
static void timer_to_check_adv_state(void)
{
...
//        at_spp_init();
        ...
        sys_timer_add(0, timer_to_check_adv_state, 500);
