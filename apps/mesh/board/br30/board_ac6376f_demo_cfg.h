#ifndef CONFIG_BOARD_AC6376F_DEMO_CFG_H
#define CONFIG_BOARD_AC6376F_DEMO_CFG_H

#include "board_ac6376f_demo_global_build_cfg.h"
...
#define TCFG_IOKEY_POWER_ONE_PORT			IO_PORTB_01        //IO按键端口1
#define TCFG_IOKEY_POWER_TWO_PORT			IO_PORTB_02		   //IO按键端口2
#define TCFG_IOKEY_POWER_THREE_PORT			IO_PORTB_03		   //IO按键端口3
