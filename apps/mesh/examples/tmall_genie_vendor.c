...
#if (CONFIG_MESH_MODEL == SIG_MESH_TMALL_GENIE_VENDOR)
 ...
 */
/*-----------------------------------------------------------*/
#define BLE_DEV_NAME        'T', 'G', '_','M', 'E', 'S', 'H'
...
#endif /* (CONFIG_MESH_MODEL == SIG_MESH_TMALL_GENIE_VENDOR) */
