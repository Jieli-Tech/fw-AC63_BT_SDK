...
#define SRC_TYPE_CHANGE_PCM_COUNT   3

#define SYNC_HIGH_RESOLUTION_ENABLE     0
...
int audio_src_base_get_rate(struct audio_src_base_handle *src, int *in_rate, int *out_rate);
