 ...
 *
 * @param cbuffer cbuffer句柄
 * @param len 回传可以最多写入len字节长度的数据
 *
 * @return 当前写指针的地址
 */
/* ----------------------------------------------------------------------------*/
 ...
 *
 * @param cbuffer cbuffer句柄
 * @param len 在非cbuffer_t结构体包含的内存空间中写入的数据的实际字节长度
 *
 * @return 当前写指针的地址
 */
/* ----------------------------------------------------------------------------*/
 ...
 *
 * @param cbuffer cbuffer 句柄
 * @param len 在非cbuffer_t结构体包含的内存空间中读取的数据的实际字节长度
 */
/* ----------------------------------------------------------------------------*/
 ...
 *
 * @param cbuffer cbuffer 句柄
 * @param begin 指向需要重写内容的开始地址
 * @param buf 指向用于存储重写内容的目标数组
 * @param len 待重写内容的长度
 *
 * @return 成功重写的字节长度
 */
