...
#define M2P_LCTM_RESET_PCNT_PRD0	P11_RAM_ACCESS(0xfeb)
#define M2P_LCTM_RESET_PCNT_PRD1	P11_RAM_ACCESS(0xfec)
#define M2P_LCTM_RESET_PCNT_VALUE	P11_RAM_ACCESS(0xfed)
