...
u32 usb_g_ep_readram(const usb_dev usb_id, const u32 ep, u8 *ptr, u32 len);
...
u32 usb_h_ep_write(const usb_dev usb_id, u8 host_ep, u16 txmaxp, u8 target_ep, u8 *ptr, u32 len, u32 xfer);
int usb_h_ep_write_async(const usb_dev id, u8 host_ep, u16 txmaxp, u8 target_ep, u8 *ptr, u32 len, u32 xfer, u32 kstart);
